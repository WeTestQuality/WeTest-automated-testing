...
class WeTestAppiumTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Remote("https://service-ifvrcbba-1251501889.gz.apigw.tencentcs.com/wd/hub", desired_caps)
        print("Connecting to WeTest WebDriver successfully")
